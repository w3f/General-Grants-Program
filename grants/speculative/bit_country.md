...
* Create Country
* Country Token Issuance With Native Token Backing
* Transfer Country Ownership
* Transfer Country Token 
* Country Voting
|  
...
| 1. | Substrate modules: Block & Section | 
* Create Block
* Transfer Block Ownership
* Transfer Block to Another Country
* Create Section in Block
* Transfer Section Ownership
* Attach Asset to Section for Decoration.
* Detach Asset to Section for Decoration.
|  
| 2. | Bit.Country Dapp - Tokenization | Users would be able to tokenize various assets as NFT onto the Bit.Country chain.|
| 3. | Bit.Country Dapp - Activities in 2D | In 2D view, users would be able to create or share content onto the timeline. Country owners can manage blocks and section|
| 4. | Bit.Country Dapp - Activities in 3D | In 3D view, users would be able to walk and attach assets within the owned sections.|
...
| 0c. | Testing Guide | The code will have proper unit-test coverage for the pallets as well as Cypress automation for dapp features.|
| 1. | Substrate module: Marketplace | 
* List Country For Auction
* List Block For Auction
* List Section For Auction
* List GenericAsset For Auction
* Bid For Asset
* List Bid History For Asset
* Get Winner for Asset
|  
